...
class TestNuclear(unittest.TestCase):
    ...
    def test_gto_nuclear_huzinaga(self):
        """
    ...
    def test_gto_nuclear_hellsing(self):
        """
        Test nuclear attraction integral for GTOs
        ...
        """
        # construct integrator object
        integrator = IntegralEvaluator(None, HellsingNuclearEngine(), None)
    ...
    def test_gto_nuclear_comparison(self):
        """
        Test nuclear attraction integral for GTOs
        ...
        """
        # construct integrator object
        integrator1 = IntegralEvaluator(None, HuzinagaNuclearEngine(), None)
        integrator2 = IntegralEvaluator(None, HellsingNuclearEngine(), None)

        # test GTO
        gto1 = GTO(0.154329, 3.425251, [1.0, 0.0, 0.0], [1, 0, 0])

        nuclear1 = integrator1.nuclear_primitive(gto1, gto1, [1.0, 0.0, 0.0])
        nuclear2 = integrator1.nuclear_primitive(gto1, gto1, [1.0, 0.0, 0.0])
        
        np.testing.assert_almost_equal(nuclear1, nuclear2, 4)        

    def test_cgf_nuclear_huzinaga(self):
        """
    ...
    def test_cgf_nuclear_hellsing(self):
        """
        Test nuclear attraction integrals for contracted Gaussians
        for the H2 molecule
    ...
    def test_nuclear_h2o_huzinaga(self):
        """
        Test nuclear attraction integrals for contracted Gaussians
    ...
    def test_nuclear_h2o_hellsing(self):
        """
        Test nuclear attraction integrals for contracted Gaussians
        for the H2O molecule
